...
public class User {
    ...
    public User(Integer id, String username, String password, String email, String phone, String question, String answer, Integer role, Integer userArticlenum, Date createTime, Date updateTime) {
        this.id = id;
